// Binary Search in a Strict Sorted Matrix
import java.util.Arrays;

public class BinarySearchInStrictSortedArray {
    public static void main(String[] args) {
        ...
        int toFind = 11;
        System.out.println(Arrays.toString(search(arr, toFind)));
    }
    ...
    static int[] search(int[][] matrix, int target) {
        ...
        if (rows == 1) return simpleBinarySearch(matrix, 0, 0, cols - 1, target);
        ...
        // Check if the target is in the middle column of the two rows
